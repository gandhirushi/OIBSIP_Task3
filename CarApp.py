...
Driven_kms = st.sidebar.number_input('Kilometers Driven', 0, 500000, 50000, 1000)

st.sidebar.subheader("Car Specifications")
fuel_type = st.sidebar.selectbox('Fuel Type', ['Petrol', 'Diesel', 'CNG'])
Selling_type = st.sidebar.selectbox('Selling_type', ['Dealer', 'Individual'])
...
if predict_btn:
    ...
    seller_encoded = {'Dealer': 0, 'Individual': 1}[Selling_type]
